...
import { Col, Row, Card, Image, Button, Container, ListGroup, Tooltip, OverlayTrigger, Form, Navbar, Nav, Badge, Alert } from '@themesberg/react-bootstrap';
...
class ZealHome extends React.Component {
  ...
  sendSubscriber = async () => {
    ...
    await axios.post('/api/subscribe_user/', { "email": this.state.subscriber })
      .then((data) => {
                ...
                <form action="#">
                  <div className="form-row mb-2">
                    <div className="col-12">
                      <input type="email" className="form-control mb-2" placeholder="example@company.com" name="email" aria-label="Subscribe form" onChange={(event) => this.setState({ subscriber: event.target.value })} required />
                    </div>
                    <div className="col-12">
                      {
